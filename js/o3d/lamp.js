...
function Lamp (options) {
  var parameters = jQuery.extend(Lamp.defaultOptions, options);
  ...
  var bodyTexture = TextureManager.load('assets/texture/laser-body.png');
  var capTexture = TextureManager.load('assets/texture/laser-cap.png');
  var flareTexture = TextureManager.load('assets/texture/laser-flare.png');
